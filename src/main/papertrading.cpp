...
AbstractPaperTrading::TradingStatus AbstractPaperTrading::getTradingStatus(const std::string_view &pair, json::Value instance) {
    ...
    AbstractPaperTrading::TradingStatus status;
...
void AbstractPaperTrading::placeOrders(const std::string_view &pair,
