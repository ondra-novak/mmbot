...
#ifndef SRC_MAIN_STRATEGY_KVLIMITED_H_
#define SRC_MAIN_STRATEGY_KVLIMITED_H_
#include <chrono>

#include "istrategy.h"

class Strategy_KVLimited: public IStrategy {
public:
	...
	Strategy_KVLimited(const Config &cfg, State &&st);
	Strategy_KVLimited(const Config &cfg);
...
#endif /* SRC_MAIN_STRATEGY_KVLIMITED_H_ */
